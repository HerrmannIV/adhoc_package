...
//#define FRAME_DATA_TYPE_SQUARE 0xf2
...
/*
	if (data_type == FRAME_DATA_TYPE_SQUARE){        
        adhoc_customize::Square square;
        desializeObject((unsigned char*) payload.data(), payload.length(), &square);
        publishMessage(square, topic);
    }
*/
}
#endif